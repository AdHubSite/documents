...
| adid_mandatory           | Boolean | X  | ADID(Android) 또는 IDFA(iOS) 필수 여부. true인 경우에만 값이 존재                         |
...
| device_ad_id  | String | X  | Android ADID 또는 iOS IDFA     |
| age           | Int    | X  | 사용자 나이                       |
